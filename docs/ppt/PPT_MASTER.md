# PPT MASTER — Presentation Workflow Specification

> Source of truth for all presentation/output work in the Store3D project.
...
PPT Master is the presentation/output layer of the Store3D AI development pipeline. It coexists with the software development workflow — it does NOT replace it.
...
**Core principle:** CANONICAL_CONTEXT.md is the source of truth for all project facts. PPT Master reads from it. Gamma renders visuals. Neither invents facts.
...
### 1.3 Technical Explanation Deck
...
### Committed to Git
- `docs/ppt/PPT_MASTER.md` — this file
